...
def command_with_config(config_file_param_name: str) -> Type[click.Command]:
    ...
    class CustomCommandClass(click.Command):
        ...
        def invoke(self, ctx):
            ...
            param_defaults = {p.human_readable_name: p.default for p in self.params if isinstance(p, click.core.Option) and p.name is not None and not p.name.startswith('fake_')}
